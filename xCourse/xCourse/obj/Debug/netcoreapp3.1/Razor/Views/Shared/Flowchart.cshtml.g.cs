#pragma checksum "C:\Users\Ferris\Documents\GitHub\3380-xCourse\xCourse\xCourse\Views\Shared\Flowchart.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "15359f955d4d16e54efb937d8cd8c39e1a9cc934"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"15359f955d4d16e54efb937d8cd8c39e1a9cc934", @"/Views/Shared/Flowchart.cshtml")]
...
<script>
  ...
  var HORIZONTAL = true;  // this constant parameter can only be set here, not dynamically
    ...
    function init() {
    if (win");
            WriteLiteral(@"dow.goSamples) goSamples();  // init for these samples -- you don't need to call this
  ...
  ");
    ...
    $(go.Part, ""Position"",
        ...
        itemTemplate:
            ...
            new go.Bin");
            WriteLiteral(@"ding(""position"", ""bounds"", function(b) { return b.position; }),
            $(go.TextBlock,
                {
            ...
            // option ");
            WriteLiteral(@"2: separator lines:
            //(HORIZONTAL
            //  ? $(go.Shape, ""LineV"",
    ...
    { // this is the information needed for the headers of the bands
        ...
        ");
#nullable restore
#line 171 "C:\Users\Ferris\Documents\GitHub\3380-xCourse\xCourse\xCourse\Views\Shared\Flowchart.cshtml"
...
#nullable disable
            WriteLiteral("\r\n        ];\r\n\r\n\r\n\r\n    var linkDataArray = [ ");
#nullable restore
#line 176 "C:\Users\Ferris\Documents\GitHub\3380-xCourse\xCourse\xCourse\Views\Shared\Flowchart.cshtml"
